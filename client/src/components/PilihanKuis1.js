...
const PilihanKuis1 = () => {
  return (
    <div className="mode">
      <Container>
        <br />
        <h1 className="mt-5 mb-0 text-center">Nggoleki Tembung</h1>
        <br />
        <Row>
            ...
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/nggolekitembung/1" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className=" text-center">
                  <a href="/games/nggolekitembung/2" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className=" text-center">
                  <a href="/games/nggolekitembung/3" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/nggolekitembung/4" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4}>
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/nggolekitembung/5" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
