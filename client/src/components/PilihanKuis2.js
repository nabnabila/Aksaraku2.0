...
const PilihanKuis2 = () => {
  return (
    <div className="mode">
      <Container>
        <br />
        <h1 className="mt-5 mb-0 text-center">Ngatur Ukara</h1>
        <br />
        <Row>
            ...
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/ngaturukara/1" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className=" text-center">
                  <a href="/games/ngaturukara/2" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className=" text-center">
                  <a href="/games/ngaturukara/3" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/ngaturukara/4" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4}>
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/ngaturukara/5" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
