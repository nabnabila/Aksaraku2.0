...
const PilihanKuis4 = () => {
  return (
    <div className="mode">
      <Container>
        <br />
        <h1 className="mt-5 mb-0 text-center">Nyocokake Gambar</h1>
        <br />
        <Row>
            ...
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/gambar/1" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className=" text-center">
                  <a href="/games/gambar/2" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className=" text-center">
                  <a href="/games/gambar/3" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4} id="categories">
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/gambar/4" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
          ...
          <Col md={4}>
            <Card className="modeImage">
              ...
              <div>
                <div className="text-center">
                  <a href="/games/gambar/5" class="btn btn-custom">
                    Mulai
                  </a>
                </div>
              </div>
